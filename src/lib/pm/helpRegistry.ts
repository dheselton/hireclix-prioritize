...
export const HELP_PACKS: HelpPack[] = [
  {
    ...
    guides: [
      ...
      { slug: "operators/career-site-project", title: "Career site project", minutes: 6, surfaces: ["templates", "work"] },
      ...
      { slug: "_shared/career-site-build", title: "Career site deep-dive", minutes: 10, surfaces: ["templates", "work"] },
