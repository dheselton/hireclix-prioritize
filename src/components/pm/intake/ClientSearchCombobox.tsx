...
export interface ClientOption { id: string; name: string; is_internal?: boolean; archived_at?: string | null }
...
interface Props {
  ...
  placeholder?: string;
  disabled?: boolean;
  /** When false, hide inline client creation (public forms). Default true for staff. */
  allowCreate?: boolean;
}

/** Searchable client picker with optional inline "New client" affordance. */
